...
dataset = GU.read("data/utmsmall.tif")
driver = GU.driver("GTiff")
@fact GU.shortname(driver) --> "GTiff"
@fact GU.longname(driver) --> "GeoTIFF"
...
@fact GU.nameof(GU.getcolorinterp(band)) --> "Gray"
...
# Using CreateCopy()
ds_src = GU.read("data/utmsmall.tif")
